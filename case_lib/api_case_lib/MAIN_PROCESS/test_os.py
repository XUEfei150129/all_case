...
# ['b3c80069-3fd1-11e9-b0af-005056883963', 'b7eef176-3fd1-11e9-b0af-005056883963', 'bc6b6bb6-3fd1-11e9-b0af-005056883963']
#
# {"plateNumber": "苏A", "isMerged": false,
#  "recommendedTruckCodes": ["b3c80069-3fd1-11e9-b0af-005056883963", "b7eef176-3fd1-11e9-b0af-005056883963",
#                            "bc6b6bb6-3fd1-11e9-b0af-005056883963"], "navigationType": "2", "navigationRules": [],
#  "positions": [
#      {"demandCode": "WL2019005669", "address": "江宁区淳化街道茶岗社区104省道", "latitude": "31.950859", "longitude": "119.014704",
#       "kilometers": 0, "order": "1", "type": "0", "mergedCodes": null, "demandHandTypes": null},
#      {"demandCode": "WL2019005669", "address": "江苏省南京市雨花台区雨花街道雨花南路2号雨花台区人民政府", "latitude": "31.991563",
#       "longitude": "118.779095", "kilometers": 0, "order": "2", "type": "1", "mergedCodes": null,
#       "demandHandTypes": null}]}
# {"plateNumber": "苏A", "isMerged": false,
#  "recommendedTruckCodes": ["b3c80069-3fd1-11e9-b0af-005056883963", "b7eef176-3fd1-11e9-b0af-005056883963",
#                            "bc6b6bb6-3fd1-11e9-b0af-005056883963"], "navigationType": "2", "navigationRules": [],
#  "positions": [
...
#       "demandHandTypes": null}]}
#
# {"transportCode": "YS2019006032", "carrierCode": "9920f956-b580-40a3-beff-381de301335f", "carrierName": "天津恒路物流有限公司",
#  "planDeliveryTime": "2019-05-08 11:52", "freightRecommended": "858.06", "freightPayable": "858.06", "dockFee": "0.00",
#  "kilometers": "42", "originalDemandCode": "WL2019005669", "reasonForFreightModified": "", "remarks": "",
#  "plateNumber": "苏A", "takeDeliveryTime": "2019-05-09 17:05", "navigationType": "2",
#  "recommendedTruckCodes": ["b3c80069-3fd1-11e9-b0af-005056883963", "b7eef176-3fd1-11e9-b0af-005056883963",
#                            "bc6b6bb6-3fd1-11e9-b0af-005056883963"], "demands": [
#     {"demandCode": "WL2019005669", "demandDeliveryAddress": "江宁区淳化街道茶岗社区104省道",
#      "demandDeliveryAddressLatitude": 31.950859, "demandDeliveryAddressLongitude": 119.014704,
#      "demandReceiptAddress": "江苏省南京市雨花台区雨花街道雨花南路2号雨花台区人民政府", "demandReceiptAddressLatitude": 31.991563,
#      "demandReceiptAddressLongitude": 118.779095, "demandType": "1", "kilometers": "0",
#      "demandRelationCode": "FWJ190560922",
#      "devices": [{"category": "FORK", "categoryName": "剪叉", "shigh": "10", "shighName": "10米", "usedAmount": "1"}]}],
#  "positions": [
#      {"demandCode": "WL2019005669", "address": "江宁区淳化街道茶岗社区104省道", "latitude": "31.950859", "longitude": "119.014704",
#       "kilometers": 0, "order": "1", "type": "0", "mergedCodes": [],
#       "demandHandTypes": [{"demandCode": "WL2019005669", "type": "0", "orderIndex": 1}]},
#      {"demandCode": "WL2019005669", "address": "江苏省南京市雨花台区雨花街道雨花南路2号雨花台区人民政府", "latitude": "31.991563",
#       "longitude": "118.779095", "kilometers": 42, "order": "2", "type": "1", "mergedCodes": [],
#       "demandHandTypes": [{"demandCode": "WL2019005669", "type": "1", "orderIndex": 2}]}], "navigationRules": []}


def test_getusercode(name):
    """
    根据用户名获取用户编码
    :return:
    """
    with open('nameinfo.txt', "r", encoding="utf-8") as f:
        lines = f.read().splitlines()
        for line in lines:
            if name in line:
                break
        name = line.split(">")[0].strip()
        usercode = line.split(">")[1].strip()
...
a = test_getaftertime(3)
print(a)


def test_getusercode(self, name):
    """
    根据用户名获取用户编码
    :return:
    """
