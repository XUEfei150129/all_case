...
class Main_Process(LoginShort, Login):
    ...
    def test_addproject(self, name="薛飞"):
        """
        创建工程
        :return: 返回值为工程号
        """
        token = self.test_Login(name)
        headers = {
    ...
    def test_crmCustomerAndProject(self, name="薛飞"):
        """
        工程关联客户
        :return:
        """
        ...
        values = {"custCode": self.cCode, "projectCode": "{}".format(pcode)}  # 这两个参数都是可以获取的
        values = json.dumps(values)
        result = requests.post(
            self.url +
    ...
    def test_projectListUnderCust(self, name="薛飞"):
        """
    ...
    def test_ceratorder(self, name="薛飞"):
        '''调用端：移动端
            应用访问地址：
    ...
    def test_needlist(self, name="黄飞"):
        '''调用端：移动端
        应用访问地址：
    ...
    def test_submitAuditInst(self, name="黄飞"):
        """
        客户经理发起订单
        城市经理审批运订单流程
        :return:
        ...
        values = {
            "status": 1,
            "submitUserCode": Read_Ini().get_value(name)[2],
            "submitUserName": name,
            "bizNo": bizNo,
            "updateUserCode": Read_Ini().get_value(name)[2],
            "updateUserName": name,
            "instNo": instNo,
            "comment": "测试"}
        values = json.dumps(values)
    ...
    def test_ordersignsave(self, name="薛飞"):
        """
        客户经理上传合同
    ...
    def test_ubmitAuditInst(self, name="陈艳艳"):
        """
        合同管理专员审批通过最新的合同
        :return:
        """
    ...
    def test_createDevEnter(self, name="薛飞"):
    ...
    def test_enterAssign(self, name="朱宽宽"):
        """
        服务经理分配进场给服务工程师
        :return:
        """
        ...
        values = {
            "devEnterCode": fwj,
            "loadingStaff": Read_Ini().get_value("江凤余")[2],
            "loadingStaffName": "江凤余",
            "deliveryStaff": Read_Ini().get_value("江凤余")[2],
    ...
    def test_getserDevEnterByCode(self, name="江凤余"):
        """
    ...
    def test_selectEnterMatchDev(self, name="江凤余"):
        """
    ...
    def test_addEnterMatchDev(self, name="江凤余"):
        """
        服务工程师选择设备
    ...
    def test_enterMatchDev(self, name="江凤余"):
        """
        将选好的设备验机
        :return:
        """
    ...
    def test_getwarehousecode(self, name="江凤余"):
        """
        获取仓库code和仓库name
    ...
    def test_createtransportdemand(self, name="江凤余", ):
        """
        发起物流需求单
        :return:物流需求单号
        """
        ...
        values = {"demandCode": "",
                  ...
                  "demandDeliveryContactCode": Read_Ini().get_value(name)[2],
                  "demandDeliveryContactName": name,
                  "demandDeliveryContactMobile": Read_Ini().get_value(name)[0],
                  ...
                  "demandReceiptContactCode": Read_Ini().get_value(name)[2],
                  "demandReceiptContactName": name,
                  "demandReceiptContactMobile": Read_Ini().get_value(name)[0],
                  "demandRelationCode": fwj,
                  "demandType": "1",
    ...
    # 下面是为发起物流运输单做准备
    def test_queryTransportOrder(self, name="朱春娇"):
        """
        根据物流需求单号获取物流运输单号
        :return:物流运输单号
        """
    ...
    def test_getRecommendTrucks(self, name="朱春娇"):
        """
    ...
    def test_carrierlist(self, name="朱春娇"):
        """
    ...
    def test_calcMileage(self, name="朱春娇"):
        """
        点击导航服务，获取公里数
        :return: 公里数
        """
    ...
    def test_freightcalculate(self, name="朱春娇"):
        """
        获取推荐运费
        :return:
        """
    ...
    def test_createtransportorder(self, name="朱春娇"):
        """
        创建物流运输单
        :return:
        """
